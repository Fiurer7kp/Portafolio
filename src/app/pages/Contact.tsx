    ...
    >
      ...
      <div className="grid md:grid-cols-2 gap-16 items-start">
        ...
        <div>
          ...
          >
            Feel free to reach out for collaborations, freelance projects, or just a friendly hello. I'm always open to new opportunities.
          </p>
        ...
        >
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
              <label className="block text-xs font-medium mb-1.5" style={{ color: 'var(--text-muted)', fontFamily: 'DM Sans, sans-serif' }}>
                First Name
              </label>
              <input
                type="text"
          ...
          <button
            ...
            className="w-full py-4 rounded-xl font-semibold text-sm flex items-center justify-center gap-2 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg"
            style={{
